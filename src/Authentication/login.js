    ...
    <ThemeProvider theme={theme}>
      <Container maxWidth={false} style={{ minHeight: "100vh", padding: 0 }}>
        <Grid container style={{ minHeight: '100vh' }}>
          ...
          <Typography variant="h5" fontWeight="italic"  style={{padding:5}}>Login to your account with username and password</Typography>
            <Grid container spacing={2} style={{ maxWidth: '80%', marginTop: '20px' }}> 
              ...
              <Grid item xs={12}>
                <NavLink to='/register' style={{paddingLeft: 13, textDecoration: 'none'}}>Don't have an account ? Register Here </NavLink>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
